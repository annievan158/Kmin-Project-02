...
$(document).ready(function(){
  ...
  add.addEventListener("click", function (event) {
    ...
    cartBox.css('width', "100%");
    } else{
      cartBox.css("display", "block");
      cartBox.css('width', "50%");
      cartBox.css('backgroundColor', "white");
    }
    updatecart()
  })
  ...
  function updatecart() {
    ...
    $(".cart-total-price")[0].innerText = total + '.000 đ'
  }
